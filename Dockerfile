...
LABEL software.version="0.19.10"
...
RUN export SNVER=${SNVER:-0.19.10} && \
 echo "SNVER is $SNVER" && \
...
/SneakerNet-${SNVER:-0.19.10}/scripts:/SneakerNet-${SNVER:-0.19.10}/SneakerNet.plugins:\
/mlst-2.19.0/bin/:\
